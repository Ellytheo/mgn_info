  ...
  return (
    ...
    >
      <div className="text-center m-3">
        <h2 className="text-warning fw-bold" style={{ textShadow: '2px 2px 8px rgba(0,0,0,0.7)' }}>
          About Magunas Wholesalers and Distributors
        </h2>
        <p>
          <strong>
            <i>Over 30 years of service to Kenyans</i>
          </strong>
        </p>
        <p style={{ fontSize: '1.1rem', lineHeight: '1.6', textShadow: '1px 1px 4px rgba(0,0,0,0.5)' }}>
      ...
      <div className="row">
        <div className="col-md-4 mb-4 mantra-mon">
          <div className="p-4 rounded shadow-lg" style={{ background: 'rgba(255,255,255,0.1)', backdropFilter: 'blur(10px)' }}>
            <h3 className="text-warning fw-bold fs-2">Our Business</h3>
        ...
        <div className="col-md-4 mb-4 mantra-mon">
          <div className="p-4 rounded shadow-lg" style={{ background: 'rgba(255,255,255,0.1)', backdropFilter: 'blur(10px)' }}>
            <h3 className="text-warning fw-bold fs-2">Our Leadership</h3>
            <hr style={{ borderColor: '#ffc107', borderWidth: '2px' }} />
            <p style={{ fontSize: '1.05rem', lineHeight: '1.6' }}>
        ...
        <div className="col-md-4 mb-4 mantra-mon">
          <div className="p-4 rounded shadow-lg" style={{ background: 'rgba(255,255,255,0.1)', backdropFilter: 'blur(10px)' }}>
            <h3 className="text-warning fw-bold fs-2">Our Founding Story</h3>
            <hr style={{ borderColor: '#ffc107', borderWidth: '2px' }} />
            <p style={{ fontSize: '1.05rem', lineHeight: '1.6' }}>
      ...
      <blockquote className="text-center m-5" style={{ fontStyle: 'italic', fontSize: '1.2rem', color: '#d4e8d4' }}>
      ...
      <div className="row">
        <div className="col-md-4 mb-4 mantra-mon">
          <div className="p-4 rounded shadow-lg" style={{ background: 'rgba(255,255,255,0.1)', backdropFilter: 'blur(10px)' }}>
            <h3 className="text-warning fw-bold fs-2">Our Impact</h3>
            <hr style={{ borderColor: '#ffc107', borderWidth: '2px' }} />
            <p style={{ fontSize: '1.05rem', lineHeight: '1.6' }}>
        ...
        <div className="col-md-4 mb-4 mantra-mon">
          <div className="p-4 rounded shadow-lg" style={{ background: 'rgba(255,255,255,0.1)', backdropFilter: 'blur(10px)' }}>
            <h4 className="text-warning fw-bold fs-3">Environmental Management</h4>
            <hr style={{ borderColor: '#ffc107', borderWidth: '2px' }} />
            <p style={{ fontSize: '1.05rem', lineHeight: '1.6' }}>
              We focus on reducing our environmental footprint through sustainable practices, eco-friendly packaging, and waste reduction initiatives.
            </p>
          </div>
        </div>
        ...
        <div className="col-md-4 mb-4 mantra-mon">
          <div className="p-4 rounded shadow-lg" style={{ background: 'rgba(255,255,255,0.1)', backdropFilter: 'blur(10px)' }}>
            <h3 className="text-warning fw-bold fs-2">Magunas Accolades</h3>
            <hr style={{ borderColor: '#ffc107', borderWidth: '2px' }} />
            <p style={{ fontSize: '1.05rem', lineHeight: '1.6' }}>
